...
// CONTROL FUNCTIONS
extern void     setSpeedDir(     uint8,  uint8, uint8 ) ;
extern void     setFunction(     uint8,  uint8, uint8 ) ;
extern void     writeCv(                uint16, uint8 ) ;
extern void     writePom(        uint8, uint16, uint8 ) ;
